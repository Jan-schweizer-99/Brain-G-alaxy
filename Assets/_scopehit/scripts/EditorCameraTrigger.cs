...
public class EditorCameraTrigger : MonoBehaviour
{
    ...
    private const double UPDATE_INTERVAL = 1.5f; // Increased to 200ms
...
private void LoadPrefab()
{
    ...
    // Asynchrones Laden des Prefabs ohne sofortigen Refresh
    EditorApplication.delayCall += () => {
        // Einmaliger Import nur für dieses Asset
        AssetDatabase.ImportAsset(prefabPath);
        
        // Zweite Verzögerung für das Laden nach dem Import
        EditorApplication.delayCall += () => {
            prefabToSpawn = AssetDatabase.LoadAssetAtPath<GameObject>(prefabPath);
        };
    };
